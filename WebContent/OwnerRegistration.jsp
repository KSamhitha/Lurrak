...
<style>
body {
    background-image: url("images/img_owner.jpg");
...
<body>
 <html>
  ...
  <form name="Owner Registration Form" method="post" action="OwnerLogin.jsp">
...
<tr>
  ...
  <center><font size=4><b>Owner Registration Form</b></font></center>
...
<tr>
  ...
  <td><input type="hidden" name="action" value=ownerRegister></td>
